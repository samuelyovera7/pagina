...
<body>
    <header class="main-header">
        <div class="container header-content">
            ...
            <nav class="main-nav">
                ...
                <a href="eventos.php" class="nav-link">Galería</a>
            ...
            <form id="formNuevosForm" action="procesar.php" method="post">
                ...
                <div class="form-group phone-wrapper">
                    ...
                    <div class="phone-input-group">
                        ...
                        <input type="tel" id="telefonoNumero" name="telefonoNumero" class="form-control" placeholder="Ej: 4121234567" required>
                    </div>
    ...
    <!-- PLAYER FLOTANTE -->
<div id="floatingRadioPlayer" class="floating-radio">

    <div class="radio-left">
        <div class="radio-cover">
            <img src="img/radio.jpg" alt="Radio Cover">
        </div>

        <div class="radio-info-box">
            <div class="radio-now">EN VIVO</div>
            <div class="radio-program-name">Radio Maranatha Aragua</div>
        </div>
    </div>

    <button id="floatingPlayBtn" class="radio-float-btn">
        <i class="fas fa-play"></i>
    </button>

    <audio id="globalRadioStream" preload="none">
        <source src="https://stream-152.zeno.fm/…TU_LINK…" type="audio/mpeg">
    </audio>
        ...
        <div class="radio-slider">
            <div class="radio-slide"><img src="img/Radio Maranatha Aragua.jpg"></div>
            <div class="radio-slide"><img src="img/Radio Maranatha Aragua 2.jpg"></div>
            <div class="radio-slide"><img src="img/Radio Maranatha Aragua 3.jpg"></div>
        </div>

        <!-- PLAYER -->
        <div class="radio-player">
            <button id="radioPlayBtn" class="radio-btn">
                <i class="fas fa-play"></i>
            </button>

            <div class="radio-info">
                <div id="radioStatus" class="radio-status">Detenido</div>
                <div class="radio-program">
                    <i class="fas fa-music"></i> Programación 24/7
                </div>
            </div>
        </div>
